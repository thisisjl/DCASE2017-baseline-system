...
from .raw_audio_utils import RawAudioBatcher
...
class SceneClassifierConvolutional(SceneClassifier, KerasMixin):
    ...
    def create_model(self, input_shape):
        ...
        if 'conv_kernel' in self.learner_params['model']:
            kernel_params = self.learner_params['model']['conv_kernel']
    ...
    def learn(self, data, annotations):
        ...
        augment_params = getattr(self.learner_params['audio'], 'data_augmentation', None)
